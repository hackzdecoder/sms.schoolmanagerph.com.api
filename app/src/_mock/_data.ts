...
export const _summary = [...Array(5)].map((_, index) => ({
  id: _id(index),
  title: [
    'Attendance report submitted for today',
    '5 New assignments have been posted',
    'Grade 10 scheduled for field trip tomorrow',
    'Library books due this week',
    'Upcoming Parent-Teacher Conference reminder',
  ][index],
  type: `announcement${index + 1}`,
  time: _times(index),
}));
